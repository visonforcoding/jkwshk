...
ATTENTION: The trailing slash is required.
*/
$baseDir = "D:/Dropbox/www/jkws/Uploads/admin/";
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . 'files'."/".date('Ymd'),
		'directory' => $baseDir . 'files'."/".date('Ymd'),
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . 'images'."/".date('Ymd'),
		'directory' => $baseDir . 'images'."/".date('Ymd'),
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Flash',
		'url' => $baseUrl . 'flash'."/".date('Ymd'),
		'directory' => $baseDir . 'flash'."/".date('Ymd'),
		'maxSize' => 0,
