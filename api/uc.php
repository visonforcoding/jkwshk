...
if (!defined('IN_UC')) {
    ...
    require_once DISCUZ_ROOT . './App/Conf/config_ucenter.php';
...
class uc_note {
    ...
    function uc_note() {
        ...
        $this->dbconfig = $this->appdir . './App/Conf/config_ucenter.php';
        $this->db = $GLOBALS['db'];
    ...
    function updateapps($get, $post) {
        ...
        //note 写配置文件
        if (is_writeable($this->appdir . './App/Conf/config_ucenter.php')) {
            $configfile = trim(file_get_contents($this->appdir . './App/Conf/config_ucenter.php'));
            $configfile = substr($configfile, -2) == '?>' ? substr($configfile, 0, -2) : $configfile;
            $configfile = preg_replace("/define\('UC_API',\s*'.*?'\);/i", "define('UC_API', '$UC_API');", $configfile);
            if ($fp = @fopen($this->appdir . './App/Conf/config_ucenter.php', 'w')) {
...
//note 使用该函数前需要 require_once $this->appdir.'./App/Conf/config_ucenter.php';
