...
<script type="text/javascript">
    $(function() {
        ...
        $('#dg').datagrid({
            url: "/Dietitians/getDietiPost.html",
            pagination: true,
            ...
            columns: [[
                    ...
                    {field: 'action', title: "操作", width: 20, formatter: function(value, row, index) {
                            return "<a class='cwp-btn'   href='/Dietitians/addPost/action/edit/id/"+row.id+".html' title='修改新闻' con='news' act='add/action/edit/id/" + row.id + "'><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>" +
        ...
        $.messager.confirm('Confirm', '确定要删除记录?', function(r) {
            if (r) {
                $.ajax({
                    ...
                    data: {"data[]": ss, 'classname': 'DieArticle'},
...
<div class="easyui-panel" title="营养师文章管理" data-options="iconCls:'icon-newspaper',collapsible:true" >
    <div id="tb" style="padding:5px;height:auto">  
        <div style="margin-bottom:5px">
            <a href="/Dietitians/addPost.html" class="easyui-linkbutton open_tab" con="news" act="add" title="添加" iconCls="icon-add" plain="true">添加</a>
