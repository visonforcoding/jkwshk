        ...
        $(function() {
            ...
            $('#dg').datagrid({
                ...
                columns: [[
                        ...
                        {field: 'id', title: 'ID'},
                        {field: 'name', title: '群组名'},
                        {field: 'info', title: '备注描述'},
                        {field: 'level', title: '等级',editor:{
                                type:'numberbox'
                            }
                        },
                        {field: 'isopen', title: '状态',width:5, editor: {
                                type: 'combobox',
                                options: {
                                    valueField: 'value',
                                    textField: 'text',
            ...
            $.messager.confirm('Confirm', '确定要删除记录?', function(r) {
                if (r) {
                    $.ajax({
                        ...
                        data: {"data[]": ss, 'classname': 'AdminGroups'},
...
<!--        <div  data-options="region:'south',split:true" style="height:50px;">
    ...
    <div class="easyui-panel" title="管理员群组管理" data-options="iconCls:'icon-users',collapsible:true,fit:true,border:false" >
        <div id="tb" style="padding:5px;height:auto">  
            <div style="margin-bottom:5px">
                <a href="/admin/addGroup/action/add" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
