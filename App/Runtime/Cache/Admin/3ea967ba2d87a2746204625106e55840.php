    ...
    $(function() {
        ...
        $('#dg').datagrid({
            ...
            columns: [[
                    ...
                    {field: 'address', title: '地址',width:20, sortable: true},
                    ...
                    {field: 'action', title: "操作", width: 20, formatter: function(value, row, index) {
                            return "<a class='cwp-btn'   href='/hospital/add/action/edit/id/"+row.id+".html' title='修改新闻' con='news' act='add/action/edit/id/" + row.id + "'><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>" +
        ...
        $.messager.confirm('Confirm', '确定要删除记录?', function(r) {
            if (r) {
                $.ajax({
                    ...
                    data: {"data[]": ss, 'classname': 'Hospital'},
...
<div class="easyui-panel" title="医院管理" data-options="iconCls:'icon-office',collapsible:true" >
    <div id="tb" style="padding:5px;height:auto">  
        <div style="margin-bottom:5px">
            <a href="/hospital/add.html" class="easyui-linkbutton open_tab" con="news" act="add" title="添加新闻" iconCls="icon-add" plain="true">添加</a>
