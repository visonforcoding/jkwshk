    ...
    <div class="easyui-panel" title="添加焦点图"  data-options="fit:true,border:false">
        <div style="padding:10px 60px 20px 60px">
            <form id="ff" method="post" class="admin-form">
                ...
                <div class="input-group">
                    <label>链接:</label>
                    <input name="link" class="easyui-validatebox" data-options="required:true" id="shorttitle" type="text" value="<?php echo ($Rs['link']); ?>" class="inputText w310" />
                </div>
                <div class="input-group">
                    <label>排序:</label>
                    <input name="level" id="shorttitle"  type="text" value="<?php echo ($Rs['level']); ?>" class="inputText" />
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    <label>焦点图类型:</label>
                    <select name="type">
                        <?php if(is_array($focusType)): $i = 0; $__LIST__ = $focusType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if($v["id"] == $Rs['type']): ?>selected="selected"<?php endif; ?> ><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="hasEditor hasPic" style="margin-top:20px;">
                    ...
                    <div id="tdimgcover" style="display: inline-block">
                        <div class="showImg" style="height:163px;">
                            ...
                            <input type="hidden" name="photo" id="litpic" value="<?php echo ($Rs['photo']); ?>"  />
                        </div>
                ...
                <div class="input-group">
                    <label>是否启用:</label>
                    启用
                    <input type="radio" name="status" value="1" <?php if(empty($status)): ?>checked<?php endif; ?> <?php if($Rs['status'] == '1'): ?>checked<?php endif; ?>   id="RadioGroup1_1" />
                    关闭
                    <input type="radio" name="status" value="0"  <?php if($Rs['status'] == '0'): ?>checked<?php endif; ?> id="RadioGroup1_1" />
                </div>
                <div class="input-group">
                    <label></label>
