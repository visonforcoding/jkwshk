...
<html>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#dg').datagrid({
                url: "/permission/getGroupAccess.html",
                pagination: true,
                ...
                columns: [[
                        ...
                        {field: 'id', title: 'ID'},
                        {field: 'groupid', title: '角色', width: 20,
                            ...
                            editor: {
                                ...
                                options: {
                                    valueField: 'id',
                                    textField: 'name',
                                    url: '/Admin/getGroupForCombobox.html',
                                    required: true
                                }
                            }
                        },
                        {field: 'accessid', title: '权限', width: 20, 
                            ...
                            editor: {
                                ...
                                options: {
                                    valueField: 'id',
                                    textField: 'title',
                                    url: '/Admin/getAccessForCombobox.html',
                                    required: true
                                }
                            }},
                        {field: 'path', title: '操作路径', width: 20},
            ...
            $.messager.confirm('Confirm', '确定要删除记录?', function(r) {
                if (r) {
                    $.ajax({
                        ...
                        data: {"data[]": ss, 'classname': 'GroupAccess'},
        ...
        function saveEdit() {
            ...
            if (typeof data === 'object' && JSON.stringify(data).length) {
                $.ajax({
                    type: "POST",
                    url: "/permission/editGroupAccess.html",
                    data: {"data": data},
                    success: function(msg) {
                        showMessage(msg.info);
                        $('#dg').datagrid('reload');
...
<!--        <div  data-options="region:'south',split:true" style="height:50px;">
    ...
    <div class="easyui-panel" title="权限管理" data-options="iconCls:'icon-key',collapsible:true,fit:true,border:false" >
