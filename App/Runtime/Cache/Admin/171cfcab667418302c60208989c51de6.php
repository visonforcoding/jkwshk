        ...
        $('#dg').datagrid({
            ...
            columns: [[
                    ...
                    {field: 'action', title: "操作", width: 20, formatter: function(value, row, index) {
                            return "<a class='cwp-btn' title='编辑' href='/picture/addPic/action/edit/id/"+row.id+".html' ><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>" +
...
<div class="easyui-panel" title="图片管理" data-options="iconCls:'icon-image2',collapsible:true" >
    <div id="tb" style="padding:5px;height:auto">  
        <div style="margin-bottom:5px">
            <a href="/picture/addPic/action/add" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
        ...
        <div>
            栏目: 
            <input class="easyui-combotree" id="pid-combotree" data-options="url:'/picture/getPicCatForCombo.html',method:'get'" style="width:200px;">
            频道: 
