        ...
        $('#dg').datagrid({
            ...
            columns: [[
                    ...
                    {field: 'action', title: "操作", formatter: function(value, row, index) {
                            return "<a class='cwp-btn' title='编辑' href='/host/addHost/action/edit/id/"+row.id+".html' ><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>" +
                ...
                <div title="机构管理" data-options="iconCls:'icon-tree2'" >
                    <ul class="page-sidebar-menu">
                        ...
                        <li>  
                         ...
                         <li>  
                            <a  href="/Corp/corpnews.html" class="add_tab" con="Live" act="upload">
                                <i class="icon-add-to-list"></i> 
...
<div class="easyui-panel" title="主持人管理" data-options="iconCls:'icon-microphone',collapsible:true" >
    <div id="tb" style="padding:5px;height:auto">  
        <div style="margin-bottom:5px">
            <a href="/host/addHost/action/add" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
