    ...
    $(function() {
        ...
        $('#dg').datagrid({
            ...
            columns: [[
                    ...
                    {field: 'time', title: '发生日期', sortable: true},
                    {field: 'ctime', title: '添加时间', sortable: true},
                    {field: 'updatetime', title: '更新时间', sortable: true},
                    {field: 'summary', title: '导言'},
                    ...
                    {field: 'action', title: "操作", formatter: function(value, row, index) {
                            return "<a class='cwp-btn' title='编辑' href='/corp/corpnews/action/edit/id/"+row.id+".html' ><span style='color:#E66A3C' class='icon-pencil2'></span> 编辑</a>" +
        ...
        $.messager.confirm('Confirm', '确定要删除记录?', function(r) {
            if (r) {
                $.ajax({
                    ...
                    data: {"data[]": ss,'classname':'CorpNews'},
...
<div class="easyui-panel" title="公司大事件管理" data-options="iconCls:'icon-microphone',collapsible:true" >
    <div id="tb" style="padding:5px;height:auto">  
        <div style="margin-bottom:5px">
            <a href="/corp/corpnews/action/add" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
