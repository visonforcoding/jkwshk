    ...
    <div class="easyui-panel" title="添加新闻"  data-options="fit:true,border:false">
        <div style="padding:10px 60px 20px 60px">
            <form id="ff" method="post" class="admin-form">
                <p>
                    <label>文章标题:</label>
                    <input class="easyui-validatebox w310" type="text" value="<?php echo ($Rs['title']); ?>"  style="width:310px;" name="title" data-options="required:true"></input>
                </p>
                <p>
                    <label>短标题:</label>
                    <input class="easyui-validatebox mid-text" value="<?php echo ($Rs['shorttitle']); ?>" type="text" name="shorttitle" ></input>
                </p>
                <p>
                    <label>所属分类:</label>
                    <?php echo ($fname); ?>
                ...
                <div class="hasEditor hasPic" style="margin-top:20px;">
                    ...
                    <div id="tdimgcover" style="display: inline-block">
                        <div class="showImg" style="height:163px;">
                            ...
                            <input type="hidden" name="litpic" id="litpic" value="<?php echo ($Rs['litpic']); ?>"  />
                        </div>
                ...
                <p>
                    <label>文章来源:</label>
                    <input class="easyui-validatebox" type="text" value="<?php echo (($Rs['source'])?($Rs['source']):'健康卫视'); ?>"  id="source" name="source"></input>
                </p>
                <p>
                    <label>作者:</label>
                <?php if(($action == add) ): ?><input name="writer" id="writer" type="text" value="<?php echo (session('NICKNAME')); ?>" class="inputText w310" />
                    <?php else: ?>
                    <input name="writer" id="writer" type="text" value="<?php echo ($Rs['writer']); ?>" class="inputText w310" /><?php endif; ?>
                </p>
                <p>
                    <label>是否启用:</label>
                    <?php echo ($fisopen); ?>
