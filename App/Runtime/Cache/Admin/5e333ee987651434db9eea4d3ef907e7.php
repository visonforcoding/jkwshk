                ...
                <div class="input-group">
                   ...
                   <div class="input-group">
                    ...
                    <select class="selectStyle" name="toppai">
                        <option value="day"   <?php if($Rs["toppai"] == 'day'): ?>selected="selected"<?php endif; ?>>今日头拍</option>
                        <option value="week" <?php if($Rs["toppai"] == 'week'): ?>selected="selected"<?php endif; ?>>本周头拍</option>
                    </select>
                </div>
                <div class="input-group">
                    <label>标签:</label>
                ...
                <div class="hasEditor hasPic" style="margin-top:20px;">
                    ...
                    <div id="tdimgcover" style="display: inline-block">
                        <div class="showImg" style="height:163px;">
                            ...
                            <input type="hidden" name="topimg" id="topimg" value="<?php echo ($Rs['topimg']); ?>"  />
                        </div>
