...
<head>
<title><?php echo ($curNews["title"]); ?>--健康卫视台</title>
...
<!--banner end-->
  ...
  <div id="about_menu">
    <ul>                                                                              
      <li><a href="index/president.html">总裁致辞</a></li>
      <li><a href="/index/about.html">关于Health TV</a></li>
      <li><a href="/index/cultural.html">文化理念 </a></li>
      <li><a href="/index/news.html" class="current">公司动态</a><span class="select"></span></li>
      <li><a href="/index/event.html">大事记录</a><span class="last_part"></span></li>
      </ul>
  </div>
  <div id="about_part_line2">&nbsp;</div>
    <div class="about_content">
      <div id="news">
      <span class="title"><?php echo ($curNews["title"]); ?></span>
       <span class="content">
            <?php echo ($curNews["content"]); ?>
       </span>
      </div>
      <div class="clear"></div>
   </div>
