...
<!--主播开始 -->
  <div id="anchors">
    <ul>
        <?php if(is_array($host)): $i = 0; $__LIST__ = array_slice($host,0,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><span class="images"><a href="/index/anchorsView/id/<?php echo ($v["id"]); ?>.html" target="_blank">
                  <img src="<?php echo ($v["tvsmpic"]); ?>" width="480" height="252"></a>
          </span><span class="content">卫视主播<br><font class="name"><?php echo ($v["name"]); ?></font></span>
          <a href="/index/anchorsView/id/<?php echo ($v["id"]); ?>.html" target="_blank"><span class="more">&nbsp;</span></a>
