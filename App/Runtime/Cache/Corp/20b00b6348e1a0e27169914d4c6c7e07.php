    ...
    <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <div id="head"> 
            <div id="top">
                ...
                <div class="menu">
                    <ul>
                        <li><a href="/index.html" onClick="change_select(this)">首页</a></li>
            ...
            <div id="aboutUs">
                <div id="about_menu">
                    <ul>                                                                              
                        ...
                        <li><a href="/index/news.html">公司动态</a></li>
                        <li><a href="/index/event.html" class="current">大事记录</a><span class="last_part"></span><span class="select"></span></li>
                    </ul>
                </div>
                ...
                <div id="event">
                    <div class="date">
                        <ul>
                            <?php if(is_array($corpNewsDate)): $i = 0; $__LIST__ = $corpNewsDate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="/index/event/year/<?php echo ($v["year"]); ?>.html" onClick="change_bg(this)" <?php if($v["year"] == $year): ?>class="current"<?php endif; ?> ><?php echo ($v["year"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>


                    <div class="content">
                        <div class="dates"><?php echo ($year); ?></div>
                        <div class="list">
                            <ul> 
                                <?php if(is_array($corpNews)): $i = 0; $__LIST__ = $corpNews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><span class="time"><?php echo ($v["time"]); ?></span><span class="title"><?php echo ($v["summary"]); ?><span class="more">>>详情</span> </span></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </div>
                        <div class="clear"></div>
                    </div>
