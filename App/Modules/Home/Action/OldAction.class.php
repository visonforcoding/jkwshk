...
/**
 * Encoding     :   UTF-8
 * Created on   :   2014-4-4 16:09:20 by 曹轩铭 , 280046197@qq.com
 * For          :   老人专栏
 */
class OldAction extends Action {

    function index() {
        $typename = "老人"; //完全可以修改成传参加载不同的CSS
        $VideoMob = D("Video");
    ...
    function Oldlist() {
        ...
        switch ($M) {
            case 'News':
                $this->display("Old/News");
                break;
            case 'Picture':
                $this->display("Old/Picture");
                break;
            case 'Video':
                $this->display("Old/Video");
                break;
            case 'Newscat':
                $this->display("Old/Newscat");
                break;
            case 'VideoCat':
                $this->display("Old/Videocat");
                break;
        }
    }
