 ...
 * For          :   美容专栏
 */
class BeautifulAction extends Action {

    function index() {
        $typename = "美容"; //完全可以修改成传参加载不同的CSS
        $VideoMob = D("Video");
        ...
        $Focus = D('Focus');
        $focusCat = $FocusCat->where("name = '美容'")->find();
    ...
    function Beautifullist() {
        ...
        switch ($M) {
            case 'News':
                $this->display("Beautiful/News");
                break;
            case 'Picture':
                $this->display("Beautiful/Picture");
                break;
            case 'Video':
                $this->display("Beautiful/Video");
                break;
            case 'Newscat':
                $this->display("Beautiful/Newscat");
                break;
            case 'VideoCat':
                $this->display("Beautiful/Videocat");
                break;
        }
    }
