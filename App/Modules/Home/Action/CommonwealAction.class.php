 ...
 * For          :   公益专栏
 */
class CommonwealAction extends Action {

    function index() {
        $typename = "公益"; //完全可以修改成传参加载不同的CSS
        $VideoMob = D("Video");
    ...
    function Commonweallist() {
        ...
        switch ($M) {
            case 'News':
                $this->display("Commonweal/News");
                break;
            case 'Picture':
                $this->display("Commonweal/Picture");
                break;
            case 'Video':
                $this->display("Commonweal/Video");
                break;
            case 'Newscat':
                $this->display("Commonweal/Newscat");
                break;
            case 'VideoCat':
                $this->display("Commonweal/Videocat");
                break;
        }
    }
