 ...
 * For          :   美食专栏
 */
class DelicacyAction extends PublicAction {

    function index() {
        $typename = "美食"; //完全可以修改成传参加载不同的CSS
        $VideoMob = D("Video");
    ...
    function Delicacylist() {
        ...
        switch ($M) {
            case 'News':
                $this->display("Delicacy/News");
                break;
            case 'Picture':
                $this->display("Delicacy/Picture");
                break;
            case 'Video':
                $this->display("Delicacy/Video");
                break;
            case 'Newscat':
                $this->display("Delicacy/Newscat");
                break;
            case 'VideoCat':
                $this->display("Delicacy/Videocat");
                break;
